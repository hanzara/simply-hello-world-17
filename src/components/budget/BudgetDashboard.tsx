        ...
        <>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Track your spending progress by category
              </CardDescription>
            </CardHeader>
            <CardContent>
                ...
                {remainingBudget.map((category) => (
                  <div key={category.id} className="space-y-2">
                    ...
                    <Progress 
                      ...
                      className={`h-2 ${category.percentage >= 100 ? 'bg-red-100' : category.percentage >= 80 ? 'bg-yellow-100' : 'bg-green-100'}`}
                    />
                    <div className="flex justify-between text-xs text-muted-foreground">
                      ...
                      <span>
                        <CurrencyDisplay 
                          ...
                          className={`inline ${category.remaining >= 0 ? 'text-green-600' : 'text-red-600'}`}
                          showToggle={false} 
                        />
                        {' remaining'}
                      </span>
